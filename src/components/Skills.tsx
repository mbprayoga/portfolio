    ...
    >
      <div className="container flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 ent flex-1">
          <div className="flex flex-col md:border-r border-fg-muted md:pr-6">
          ...
          <div className="md:pl-6 flex md:flex-row py-6 md:py-0 flex-col-reverse items-center gap-6">
            <div
            ...
            <div className="md:hidden flex-1 w-full flex flex-col items-center gap-3">
              <div className="flex items-center gap-4 w-full justify-between px-2">
                <button
                  type="button"
                  onClick={() => {
                    setActiveIndex(
                      (i) => (i - 1 + skills.length) % skills.length,
                    );
                    setPaused(true);
                    setTimeout(() => setPaused(false), 3000);
                  }}
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <hr className="border-fg-muted my-1 w-full" />
